...
Route::post('simpanNilai', 'DashboardController@simpanNilai')->name('simpanNilai');
Route::post('admin/hapusDokumen', 'DashboardController@hapusDokumen')->name('hapusDokumen');
