...
class DashboardController extends Controller
{
    ...
    public function dokumenAkreditasi()
    {
        ...
        $data = DB::table('dokumen_akreditasi')->where('bab', $bab)->where('elemen_penilaian', $kriteria)->where('ep', $elemen)->groupBy('bab')->get();
    ...
    public function hapusDokumen(Request $request)
    {
        ...
        return redirect('admin/dashboard')->withSuccess('Nilai Berhasil diHapus!!');
