        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <td><button type="button" class="btn btn-success"><i class="fas fa-percent"></i> Lihat</button> <button type="button" class="btn btn-warning"><i class="fas fa-file-pdf"></i> Lihat</button> </td>
                    </tr>
                    `);
                });
