                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <strong>Nilai EP</strong>
                                    </div>
                                    <div class="col-sm-9" id="nilaiEP">
...
<script type="text/javascript">
    ...
    $('.modalNilai').on('click', function(e) {
        e.preventDefault()
        console.log('aaaaa')
        $('.nilaiBos').show()
    ...
    function nilaiDokumen(ep, id) {
        var nilaiDokumen = $("#nilai_" + id).val()
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 0) {
                    $('#nilaiEP').html(`<button class="btn btn-danger btn-lg modalNilai" data-toggle="modal" data-target="#dokumenModal_` + data + `">0/10</button>`)
                } else if (data == 5) {
                    $('#nilaiEP').html(`<button class="btn btn-warning btn-lg modalNilai" data-toggle="modal" data-target="#dokumenModal_` + data + `">5/10</button>`)
                } else if (data == 10) {
                    $('#nilaiEP').html(`<button class="btn btn-success btn-lg modalNilai" data-toggle="modal" data-target="#dokumenModal_` + data + `">10/10</button>`)
                }
            },
            error: function(data) {
                alert('gagal')
    ...
    $('#cariDokumen').on('click', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#tabel_dokumen").show()
                $('body').append(`
                    <div class="modal fade nilaiBos"  tabindex="-1" role="dialog" aria-labelledby="nilaiModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" id="id_` + data[key]['id'] + `" value="` + data[key]['ep'] + `">
                                        <select name="nilai" id="nilai_` + data[key]['id'] + `" class="form-control">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" onClick="nilaiDokumen('` + data[key]['ep'] + `','` + data[key]['id'] + `')" class="btn btn-primary">Save changes</button>
                                    </div>
                            </div>
                        </div>
                    </div>
                ...
                $.each(data, function(key, value) {
                    ...
                    if (data[key]['nilai'] == 0) {
                        $('#nilaiEP').html(`<button class="btn btn-danger btn-lg modalNilai" data-toggle="modal" data-target="#dokumenModal_` + data[key]['id'] + `">0/10</button>`)
                    } else if (data[key]['nilai'] == 5) {
                        $('#nilaiEP').html(`<button class="btn btn-warning btn-lg modalNilai" data-toggle="modal" data-target="#dokumenModal_` + data[key]['id'] + `">5/10</button>`)
                    } else if (data[key]['nilai'] == 10) {
                        $('#nilaiEP').html(`<button class="btn btn-success btn-lg modalNilai" data-toggle="modal" data-target="#dokumenModal_` + data[key]['id'] + `">10/10</button>`)
                    }
