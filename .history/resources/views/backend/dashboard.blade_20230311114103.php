    ...
    function nilaiDokumen(ep, id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 0) {
                    $('#nilaiEP').html(`<button class="btn btn-danger btn-lg" data-toggle="modal" data-target="#nilaiModal_` + ep + `">0/10</button>`)
                } else if (data == 5) {
                    $('#nilaiEP').html(`<button class="btn btn-warning btn-lg" data-toggle="modal" data-target="#nilaiModal_` + ep + `">5/10</button>`)
                } else if (data == 10) {
                    $('#nilaiEP').html(`<button class="btn btn-success btn-lg" data-toggle="modal" data-target="#nilaiModal_` + ep + `">10/10</button>`)
                }
            },
            error: function(data) {
                alert('gagal')
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    if (data[key]['nilai'] == 0) {
                        $('#nilaiEP').html(`<button class="btn btn-danger btn-lg" data-toggle="modal" data-target="#nilaiModal_` + data[key]['ep'] + `">0/10</button>`)
                    } else if (data[key]['nilai'] == 5) {
                        $('#nilaiEP').html(`<button class="btn btn-warning btn-lg" data-toggle="modal" data-target="#nilaiModal_` + data[key]['ep'] + `">5/10</button>`)
                    } else if (data[key]['nilai'] == 10) {
                        $('#nilaiEP').html(`<button class="btn btn-success btn-lg" data-toggle="modal" data-target="#nilaiModal_` + data[key]['ep'] + `">10/10</button>`)
                    }
                    ...
                    $('body').append(`
                    <div class="modal fade nilaiModal_` + data[key]['ep'] + `" id="nilaiModal_` + data[key]['ep'] + `" tabindex="-1" role="dialog" aria-labelledby="nilaiModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                    <div class="modal-header">
