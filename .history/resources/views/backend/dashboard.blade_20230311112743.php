                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9" id="nilaiEP">
                                        <button class="btn btn-success">10/10</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function nilaiDokumen(ep, id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 0) {
                    $('#nilaiDari_' + id).text("0/10")
                    $('#nilaiDari_' + id).removeAttr("class")
                    $('#nilaiDari_' + id).addClass("btn btn-danger")
                } else if (data == 5) {
                    $('#nilaiDari_' + id).text("5/10")
                    $('#nilaiDari_' + id).removeAttr("class")
                    $('#nilaiDari_' + id).addClass("btn btn-warning")
                } else if (data == 10) {
                    $('#nilaiDari_' + id).text("10/10")
                    $('#nilaiDari_' + id).removeAttr("class")
                    $('#nilaiDari_' + id).addClass("btn btn-success")
                }
            },
            error: function(data) {
                alert('gagal')
