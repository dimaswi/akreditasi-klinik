        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#nilaiModal"><i class="fas fa-percent"></i> Nilai</button> <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#dokumenModal"><i class="fas fa-file-pdf"></i> Lihat</button> </td>
                    </tr>
                    `);
                    ...
                    <div class="modal fade" id="dokumenModal" tabindex="-1" role="dialog" aria-labelledby="dokumenModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-body">
                            <iframe src="{{ url('Lampiran/'.$surat_masuk->lampiran_surat) }}" align="top" height="620" width="100%" frameborder="0" scrolling="auto"></iframe>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary">Save changes</button>
