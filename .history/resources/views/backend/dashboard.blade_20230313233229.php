                        ...
                        <div class="row" id="uploadDoc" style="display: none;">
                            ...
                            <div class="col-sm-8">
                                <form method="POST" id="tambah_file" enctype="multipart/form-data" action="javascript:void(0)">
                                    <input type="text" id="bab_1" name="bab_1" style="display: none;">
                                    <input type="text" id="ep_1" name="ep_1" style="display: none;">
                                    <input type="text" id="elemen_1" name="elemen_1" style="display: none;">
