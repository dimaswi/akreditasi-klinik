        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    if(data[key]['nilai'] == 0) {
                        $html = '<button type="button" class="btn btn-danger" disabled>0/10</button>'
                    }elseif(data[key]['nilai'] == 5){
                        $html = '<button type="button" class="btn btn-warning" disabled>5/10</button>'
                    }elseif(data[key]['nilai']== 10){
                        $html = '<button type="button" class="btn btn-success" disabled>10/10</button>'
                    }
                    ...
                    <td>` + data[key]['ep'] + `</td>
                    <td>` + + `</td>
                    <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#nilaiModal_` + key + `"><i class="fas fa-percent"></i> Nilai</button> <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#dokumenModal_` + key + `"><i class="fas fa-file-pdf"></i> Lihat</button> </td>
                    </tr>
                    `);
