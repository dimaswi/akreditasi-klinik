                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" id="id_` + data[1]['id'] + `" value="` + data[1]['ep'] + `">
                                        <select name="nilai" id="nilai_` + data[1]['id'] + `" class="form-control">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" onClick="nilaiDokumen('` + data[1]['ep'] + `','` + data[1]['id'] + `')" class="btn btn-primary">Save changes</button>
                                    </div>
                            </div>
                        </div>
                    </div>
