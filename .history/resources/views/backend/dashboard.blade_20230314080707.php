                        ...
                        <div class="row" id="uploadDoc" style="display: none;">
                            ...
                            <div class="col-sm-8">
                                <form method="POST" id="tambah_file" enctype="multipart/form-data" action="{{ route('admin.dokumenTambahan') }}">
                                    {{ csrf_field() }}
                                    <input type="text" id="bab_1" name="bab" style="display: none;" value="">
                                    <input type="text" id="ep_1" name="ep" style="display: none;" value="">
                                    <input type="text" id="elemen_1" name="elemen" style="display: none;" value="">
