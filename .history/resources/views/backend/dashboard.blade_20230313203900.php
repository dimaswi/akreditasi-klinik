                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <button type="button" id="dokumenTambahan" class="btn btn-primary" style="margin-top:10px; display: none;" data-toggle="modal" data-target=".dokumenTambahan">
                                    Upload
                                </button>
                            </div>
                        </div>
...
<!-- Modal -->
<div class="modal fade dokumenTambahan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
