                        ...
                        <div class="row" id="uploadDoc" style="display: none;">
                            ...
                            <div class="col-sm-8">
                                <form method="POST" id="tambah_file" enctype="multipart/form-data" action="javascript:void(0)">
                                    <input type="hidden" id="bab_1" name="bab_1">
                                    <input type="hidden" id="ep_1" name="ep_1">
                                    <input type="hidden" id="elemen_1" name="elemen_1">
...
<script type="text/javascript">
    ...
    $('#kirimFileTambahan').on('click', function(e) {
        var namaFile = $('#fileTambahan').val().replace(/C:\\fakepath\\/i, '')
