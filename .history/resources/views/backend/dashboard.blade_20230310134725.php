        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <tr id="a">
                    <td>` + a++ + `</td>
                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalDetailSPRI_` + [index] + `">` + data[key][index]['noSuratKontrol'] + `</button></td>
                    <td>` + data[key][index]['jnsPelayanan'] + `</td>
                    <td>` + data[key][index]['tglRencanaKontrol'] + `</td>
                    <td>` + data[key][index]['tglTerbitKontrol'] + `</td>
                    <td>` + data[key][index]['noSepAsalKontrol'] + `</td>
                    <td>` + data[key][index]['namaPoliAsal'] + `</td>
                    <td>` + data[key][index]['namaPoliTujuan'] + `</td>
                    <td>` + data[key][index]['namaDokter'] + `</td>
                    <td>` + data[key][index]['noKartu'] + `</td>
                    <td>` + data[key][index]['nama'] + `</td>
                    </tr>
                    `);
                });
            },
