    ...
    function nilaiDokumen(ep, id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                var namaclass = $('#nilaiDari_'+id).attr('class')
                if(data == 0){
                    $('#nilaiDari_'+id).text("0/10")
                    $('#nilaiDari_'+id).removeClass("btn btn-danger")
                    $('#nilaiDari_'+id).addClass("btn btn-danger")
                }else if(data == 5) {
                    $('#nilaiDari_'+id).text("5/10")
                    $('#nilaiDari_'+id).toggleClass("btn btn-warning")
                }else if(data == 10){
                    $('#nilaiDari_'+id).text("10/10")
                    $('#nilaiDari_'+id).toggleClass("btn btn-success")
                }
