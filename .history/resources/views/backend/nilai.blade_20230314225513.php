        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(key, value) {
                    ...
                    <td>` + data[key]['ep'] + `</td>
                    <td>` + nilai + `</td>
                    <td><button class="btn btn-success" data-toggle="modal" data-target="#modalDocument_`+key+`"> <i class="fas fa-folder"></i> <span style="display:none;">`+key+`</span> </button></td>
                    </tr>
                    `)

                    $('body').append(`
                    <!-- Modal -->
                    <div class="modal fade" id="modalDocument`+key+`" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
