        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <tr id="a">
                    <td>` + a++ + `</td>
                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalDetailSPRI_` + [index] + `">` + data[key][]['noSuratKontrol'] + `</button></td>
                    <td>` + data[key][]['jnsPelayanan'] + `</td>
                    <td>` + data[key][]['tglRencanaKontrol'] + `</td>
                    <td>` + data[key][]['tglTerbitKontrol'] + `</td>
                    <td>` + data[key][]['noSepAsalKontrol'] + `</td>
