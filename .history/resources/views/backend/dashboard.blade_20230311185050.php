                    ...
                    <div class="modal fade" id="nilaiBos" tabindex="-1" role="dialog" aria-labelledby="nilaiModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" id="id_` + data[idList]['ep'] + `" value="` + data[idList]['ep'] + `">
                                        <select name="nilai" id="nilai_` + data[idList]['id'] + `" class="form-control">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <button type="button" onClick="nilaiDokumen('` + data[idList]['ep'] + `','` + data[idList]['id'] + `')" class="btn btn-primary">Save changes</button>
                                    </div>
                            </div>
                        </div>
                    </div>
