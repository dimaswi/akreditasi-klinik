        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(key, value) {
                    ...
                    var val = data[key]['ep'].replace(/[!"#$%&'()*+,.\/:;<=>?@[\\\]^`{|}~]/g, "\\\\$&")
                    $('.modal-body'+data[key]['ep']).append(`<iframe src="{{ url('files/` + namafile + `') }}" align="top" height="620" width="100%" frameborder="0" scrolling="auto"></iframe>`)
                })
            },
            error: function(data) {
                console.log('error')
                ...
                $.each(data, function(key, value) {
                    ...
                    <div class="modal fade" id="modalDocument_` + key + `" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="modal-body_`+ data[key]['ep'] +`" >
