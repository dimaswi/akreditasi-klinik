    ...
    function nilaiDokumen(ep, id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 0) {
                    $('#nilaiEP').html(`<button class="btn btn-danger btn-lg">0/10</button>`)
                } else if (data == 5) {
                    $('#nilaiEP').html(`<button class="btn btn-warning btn-lg">5/10</button>`)
                } else if (data == 10) {
                    $('#nilaiEP').html(`<button class="btn btn-success btn-lg">10/10</button>`)
                }
            },
            error: function(data) {
                alert('gagal')
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <td><button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#dokumenModal_` + key + `"><i class="fas fa-file-pdf"></i></button> <button type="button" class="btn btn-danger" onClick="deleteDokumen(` + data[key]['id'] + `)"><i class="fas fa-trash"></i></button></td>
                    </tr>
                    `);
