...
<script type="text/javascript">
    ...
    $('#dokumenTambahan').on('click', function(e) {
        ...
        var input = `<div class="row" id="uploadDoc">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group control-group lst increment">
                                        ...
                                        <div class="input-group-btn">
                                            <button class="btn btn-success tambah_file" id="addFile" type="button"><i class="fldemo glyphicon glyphicon-plus"></i>Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>`
        $('#inputDokumen').append(input)
    })
