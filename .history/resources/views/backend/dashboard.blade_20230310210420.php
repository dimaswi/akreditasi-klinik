...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <td>` + data[key]['ep'] + `</td>
                    <td>` + html + `</td>
                    <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#nilaiModal_` + key + `"><i class="fas fa-percent"></i></button> <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#dokumenModal_` + key + `"><i class="fas fa-file-pdf"></i></button> <a href="javascript:void(0);" class="btn btn-danger hapusDokumen" data-id="`+ data[key]['id'] +`"><i class="fas fa-trash"></i></a></td>
                    </tr>
                    `);
    ...
    $(".hapusDokumen").on("click", function(){
