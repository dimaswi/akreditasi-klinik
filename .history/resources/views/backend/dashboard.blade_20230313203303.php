                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <button type="button" class="btn btn-primary" id="buttondokumenTambahan" data-toggle="modal" data-target="#dokumenTambahan" style="margin-top:10px; display: none;">Upload</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--Modal Dokumen-->
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="dokumenTambahan" aria-hidden="true">
