                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <button type="button" class="btn btn-primary" id="dokumenTambahan" data-toggle="modal" data-target="#dokumenTambahan" style="margin-top:10px; display: none;">Upload</button>
                            </div>
                        </div>
                    </div>
                </div>
