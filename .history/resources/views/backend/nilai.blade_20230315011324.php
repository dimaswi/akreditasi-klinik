            ...
            success: function(data) {
                $.each(data, function(key, value) {
                    ...
                    $('<iframe>') // Creates the element
                        .attr('src', namafile) // Sets the attribute spry:region="myDs"
                        .attr('height', 620)
                        .attr('width', 700)
                        .appendTo(interface);
                })
                ...
                $.each(data, function(key, value) {
                    ...
                    <div class="modal fade" id="modalDocument_` + key + `" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <iframe class="data_` + data[key]['ep'] + `" align="top" height="620" width="100%" frameborder="0" scrolling="auto"></iframe>
                            </div>
