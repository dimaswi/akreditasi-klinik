        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(key, value) {
                    $('#' + data[key][ep]).append(`
                    <button onclick="getDocument('` + data[key]['ep'] + `')" class="btn btn-success" data-toggle="modal" data-target="#modalDocument_` + key + `"> <i class="fas fa-folder"></i> <span style="display:none;">` + key + `</span> </button>
                    `)
                })
            },
            error: function(data) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(key, value) {
                    ...
                    <td>` + data[key]['ep'] + `</td>
                    <td>` + nilai + `</td>
                    <td  id="` + data[key]['ep'] + `"><button onclick="getDocument('` + data[key]['ep'] + `')" class="btn btn-success" data-toggle="modal" data-target="#modalDocument_` + key + `"> <i class="fas fa-folder"></i> <span style="display:none;">` + key + `</span> </button></td>
                    </tr>
                    `)
