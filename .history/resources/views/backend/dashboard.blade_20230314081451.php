                                ...
                                <form method="POST" id="tambah_file" enctype="multipart/form-data" action="{{ route('admin.dokumenTambahan') }}">
                                    ...
                                    <div class="input-group hdtuto control-group lst increment">
                                        ...
                                        <div class="input-group-btn">
                                            <button class="btn btn-success" id="kirimFileTambahan" type="button" ><i class="fldemo glyphicon glyphicon-plus"></i>Kirim</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    ...
    $("body").on("click", "#kirimFileTambahan", function(e) {
