        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(key, value) {
                    ...
                    var iframe = document.getElementById(namaEP)
                    var html = `<iframe src="{{ url('files/` + namafile + `') }}" align="top" height="620" width="100%" frameborder="0" scrolling="auto"></iframe>`
                    $('#'+namaEP).appendTo(``<iframe src="{{ url('files/` + namafile + `') }}" align="top" height="620" width="100%" frameborder="0" scrolling="auto"></iframe>``)
                ...
                $.each(data, function(key, value) {
                    ...
                    <div class="modal fade" id="modalDocument_` + key + `" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="modal-body" id="` + data[key]['ep'] + `">
                            </div>
