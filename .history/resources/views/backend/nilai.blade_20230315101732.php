        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(key, value) {
                    ...
                    <td>` + data[key]['ep'] + `</td>
                    <td>` + nilai + `</td>
                    <td><span><button onclick="getDocument('` + data[key]['ep'] + `','` + data[key]['uid'] + `')" class="btn btn-success" data-toggle="modal" data-target="#modalDocument_` + key + `"> <i class="fas fa-folder"></i></button><button class="btn btn-primary" data-toggle="modal" data-target="#modalDocument_` + key + `"> <i class="fas fa-comment-dots"></i> </button></span></td>
                    </tr>
                    `)
                    ...
                    <div class="modal fade" id="modalDocument_` + key + `" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="modal-body" id="` + data[key]['uid'] + `">
