                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select name="" id="ep" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <select name="" id="elemen" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <button type="button" class="btn btn-primary" id="dokumenTambahan" data-toggle="modal" data-target="#exampleModal" style="margin-top:10px; display: none;">Upload Dokumen Tambahan</button>
                                <button type="button" class="btn btn-primary" id="dokumenTambahan-close" data-toggle="modal" data-target="#exampleModal" style="margin-top:10px; display: none;">Upload Dokumen Tambahan</button>
                            </div>
                        </div>
                        ...
                        <div class="row" id="uploadDoc" style="display: none;">
                            ...
                            <div class="col-sm-8">
                                <form method="POST" id="tambah_file" enctype="multipart/form-data" action="{{ route('admin.dokumenTambahan') }}">
                                    {{ csrf_field() }}
                                    <input type="text" id="bab_1" name="bab" style="display: none;">
                                    <input type="text" id="ep_1" name="ep" style="display: none;">
                                    <input type="text" id="elemen_1" name="elemen" style="display: none;">
                                    <div class="input-group hdtuto control-group lst increment">
                                        <input type="file" name="file" id="fileTambahan" accept="application/pdf" class="myfrm form-control">
                                        <div class="input-group-btn">
                                            <button class="btn btn-success" id="kirimFileTambahan" type="button" onclick="kirimData()"><i class="fldemo glyphicon glyphicon-plus"></i>Kirim</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    ...
    function kirimData() {
        var file_data = $('#fileTambahan').prop('files')[0];
        var formData = new FormData()
        formData.append('bab', $('#bab_1').val())
        formData.append('ep', $('#ep_1').val())
        formData.append('elemen', $('#elemen_1').val())
