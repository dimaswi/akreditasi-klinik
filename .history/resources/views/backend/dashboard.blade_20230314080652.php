                        ...
                        <div class="row" id="uploadDoc" style="display: none;">
                            ...
                            <div class="col-sm-8">
                                <form method="POST" id="tambah_file" enctype="multipart/form-data" action="{{ route('admin.dokumenTambahan') }}">
                                    {{ csrf_field() }}
                                    <input type="text" id="bab_1" name="bab_1" style="display: none;" value="">
                                    <input type="text" id="ep_1" name="ep_1" style="display: none;" value="">
                                    <input type="text" id="elemen_1" name="elemen_1" style="display: none;" value="">
...
<script type="text/javascript">
    ...
    function kirimData() {
        ...
        formData.append('bab_1', $('#bab_1').val())
        formData.append('ep_1', $('#ep_1').val())
        formData.append('elemen_1', $('#elemen_1').val())
