        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#nilaiModal"><i class="fas fa-percent"></i> Nilai</button> <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#dokumenModal_`+ key +`"><i class="fas fa-file-pdf"></i> Lihat</button> </td>
                    </tr>
                    `);
