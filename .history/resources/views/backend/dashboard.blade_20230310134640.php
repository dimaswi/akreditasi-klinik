        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <tr id="a">
                    <td>` + a++ + `</td>
                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalDetailSPRI_` + [index] + `">` + data['list'][index]['noSuratKontrol'] + `</button></td>
                    <td>` + data['list'][index]['jnsPelayanan'] + `</td>
                    <td>` + data['list'][index]['tglRencanaKontrol'] + `</td>
                    <td>` + data['list'][index]['tglTerbitKontrol'] + `</td>
                    <td>` + data['list'][index]['noSepAsalKontrol'] + `</td>
                    <td>` + data['list'][index]['namaPoliAsal'] + `</td>
                    <td>` + data['list'][index]['namaPoliTujuan'] + `</td>
                    <td>` + data['list'][index]['namaDokter'] + `</td>
                    <td>` + data['list'][index]['noKartu'] + `</td>
                    <td>` + data['list'][index]['nama'] + `</td>
                    </tr>
                    `);
                });
            },
