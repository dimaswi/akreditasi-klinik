    ...
    $('#cariDokumen').on('click', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#tabel_dokumen").show()
                $('body').append(`
                    <div class="modal fade nilaiBos" id="" tabindex="-1" role="dialog" aria-labelledby="nilaiModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" id="id_` + data[1]['ep'] + `" value="` + data[1]['ep'] + `">
                                        <select name="nilai" id="nilai_` + data[1]['ep'] + `" class="form-control">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" onClick="nilaiDokumen('` + data[1]['ep'] + `')" class="btn btn-primary">Save changes</button>
                                    </div>
                            </div>
                        </div>
                    </div>
