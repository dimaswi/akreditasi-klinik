    ...
    function nilaiDokumen(ep, id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 0) {
                    $('#nilaiEP').html('<button class="btn btn-danger">0/10</button>')


                } else if (data == 5) {
                    $('#nilaiEP').html('<button class="btn btn-warning">5/10</button>')


                } else if (data == 10) {
                    $('#nilaiEP').html('<button class="btn btn-success">10/10</button>')
