        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data, function(key, value) {
                    ...
                    <td>` + data[key]['ep'] + `</td>
                    <td>` + nilai + `</td>
                    <td><span style="display:inline;"><button onclick="getDocument('` + data[key]['ep'] + `','` + data[key]['uid'] + `')" class="btn btn-success" data-toggle="modal" data-target="#modalDocument_` + key + `"> <i class="fas fa-folder"></i> <span style="display:none;">` + key + `</span> </button></span><span style="display:inline;"><button class="btn btn-primary" data-toggle="modal" data-target="#modalDocument_` + key + `"> <i class="fas fa-comment-dots"></i> <span style="display:none;">` + key + `</span> </button></span></td>
                    </tr>
                    `)
