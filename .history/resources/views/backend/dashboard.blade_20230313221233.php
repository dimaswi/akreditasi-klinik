...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data" id="tambah_file" action="javascript:void(0)">
                    <div class="row">
                        <div class="col">
                            <div class="row">
                                <div class="col-sm-4">
                            ...
                            <div class="row" id="uploadDoc" style="display: none;">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group hdtuto control-group lst increment">
                                        <input type="file" name="fileTambahan" accept="application/pdf" class="myfrm form-control">
                                        <div class="input-group-btn">
                                            <button class="btn btn-success " type="submit"><i class="fldemo glyphicon glyphicon-plus"></i>Kirim</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $('#tambah_file').on('submit', function(e) {
        var formData = new FormData()
        formData.append('bab', $("#parentCombo").val());
        formData.append('ep', $("#parentCombo").val());
        formData.append('elemen', $("#parentCombo").val());
        formData.append('fileTambahan', $("#parentCombo").val());
