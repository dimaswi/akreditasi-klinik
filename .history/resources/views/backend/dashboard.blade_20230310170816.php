        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    <td>` + data[key]['ep'] + `</td>
                    <td>` + html + `</td>
                    <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#nilaiModal_` + key + `"><i class="fas fa-percent"></i> Nilai</button> <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#dokumenModal_` + key + `"><i class="fas fa-file-pdf"></i> Lihat</button> <button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#dokumenModal_` + key + `"><i class="fas fa-file-pdf"></i> Lihat</button></td>
                    </tr>
                    `);
